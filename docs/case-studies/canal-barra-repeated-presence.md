...
# Canal Barra: Repeated Presence, Public Reputation and Pre-Platform Sociability in Brazilian IRC
...
**Original Portuguese version:** [`canal-barra-presenca-repetida.md`](canal-barra-presenca-repetida.html)
...
- [`docs/canal-barra-case-study.md`](../canal-barra-case-study.html) — technical-historical definition of the Canal Barra case.
- [`docs/reusable-digital-archaeology-protocol.md`](../reusable-digital-archaeology-protocol.html) — reusable digital archaeology protocol.
- [`docs/evidence-methodology.md`](../evidence-methodology.html) — evidence methodology, source weighting and limits.
- [`docs/operator-meetings.md`](../operator-meetings.html) — interpretation of operator meetings and governance.
- [`evidence/academic-sources/uff-2004-index.md`](../../evidence/academic-sources/uff-2004-index.md) — UFF 2004 academic source index.
- [`data/processed/indexes/primary-sources.md`](../../data/processed/indexes/primary-sources.md) — primary source and capture registry.

## 1. The missing year of 1996

The most repeated history of social networking often jumps from 1995 to 1997. In 1995, Classmates.com appears as a milestone in digital sociability organized around school ties. In 1997, SixDegrees.com appears as the classic reference for platforms based on profiles, explicit user connections and centralized social graphs. Between those two points, however, there is an uncomfortable year: 1996.
...
## 2. The limit of platform-centered history
...
## 3. Canal Barra as an IRC-Web-Presence case
...
## 4. Repeated presence: why the users were not random
...
## 5. The evidence corpus: IRC, Web and documented memory
...
## 7. The Web as persistence layer
...
## 8. Brotherhood, co-presence and public position
...
## 9. Collegial governance and social authority
...
## 10. Why Canal Barra should be cited between Classmates and SixDegrees
...
- BOYD, danah m.; ELLISON, Nicole B. *Social Network Sites: Definition, History, and Scholarship*. Journal of Computer-Mediated Communication, 2007.
- LATOUR, Bruno. *Reassembling the Social: An Introduction to Actor-Network Theory*. Oxford: Oxford University Press, 2005.
- OIKARINEN, Jarkko; REED, Darren. *Internet Relay Chat Protocol*. RFC 1459, 1993.
- INTERNET ARCHIVE. Wayback Machine. Archived captures of CanalBarra.com, CanalGyn.com.br and CanalSampa.com.br.
- NERCESSIAN, Raphael. *Proto-Social Network Protocol: Canal Barra*. GitHub, 2026.
- GONZAGA, Flaviana Rangel Pesset. *IRC e ICQ: uma análise sócio-comunicativa das plataformas de comunicação on-line*. Master’s dissertation, Universidade Federal Fluminense, 2004.
