...
| UFF monograph 2004 | partially_available | high | `docs/FOUNDER-CULTURAL-CIRCUIT-2004.md`; `REFERENCES.md` | Add title, author, institution metadata, URL, repository record or PDF citation if legally safe. | Important external academic corroboration. |
...
| Public photo metadata for IRContros | partially_available | high | `data/raw/ircontros/`; `docs/IMAGE-MANIFEST-REVEILLON-2000-2001.md` | Add event-level manifests, consent status, public-safe captions and source hashes. | Strong online/offline evidence; medium privacy risk. |
...
| BRASnet / IRC history references in Brazil | partially_available | medium | `REFERENCES.md`; `docs/HISTORIOGRAPHICAL-PRECEDENTS.md` | Add bibliography, academic papers, archived BRASnet pages and historical references. | Helps contextualize Canal Barra inside Brazilian internet history. |
...
| ISBN / metadata for related books | missing | medium | `REFERENCES.md` | Add ISBN, title, author, publisher, year and relation to Canal Barra if applicable. | Avoid vague literary-reference claims. |
