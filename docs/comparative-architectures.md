# Comparative Architectures: Classmates, Canal Barra, SixDegrees and AIM
...
## Classmates.com: chronological precedence, different architecture
...
## SixDegrees.com: why the canon favored the profile graph
...
## AIM: presence without the same public arena
...
- a persistent public web layer through CanalBarra.com;
- local offline conversion through IRContros, beach outings, pizzeria meetups, parties, school, university and neighborhood circulation.
...
- [`docs/canal-barra-case-study.md`](canal-barra-case-study.md) — technical-historical case summary.
- [`docs/case-studies/canal-barra-presenca-repetida.md`](case-studies/canal-barra-presenca-repetida.md) — long narrative case study.
- [`docs/reusable-digital-archaeology-protocol.md`](reusable-digital-archaeology-protocol.md) — portable archival protocol.
- [`docs/historiographical-context-barra.md`](historiographical-context-barra.md) — cultural and territorial context of Barra da Tijuca.
- [`docs/evidence-methodology.md`](evidence-methodology.md) — evidence labels and methodological boundaries.
...
- GONZAGA, Flaviana Rangel Pesset. *IRC e ICQ: uma análise sócio-comunicativa das plataformas de comunicação on-line*. Universidade Federal Fluminense, 2004.
- OIKARINEN, Jarkko; REED, Darren. *Internet Relay Chat Protocol*. RFC 1459, 1993.
- Repository evidence files and structured datasets listed in [`data/processed/indexes/primary-sources.md`](../data/processed/indexes/primary-sources.md).
