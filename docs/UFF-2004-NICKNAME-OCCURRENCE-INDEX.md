...
The counts below are founder-provided counts until the repository contains searchable dissertation text, page references or extracted chat-log excerpts.
...
Do not treat the numbers in this document as fully verified until the repository contains the source text or extracted occurrence table.

The correct current status is:

```text
reported by founder; pending repository verification
```
