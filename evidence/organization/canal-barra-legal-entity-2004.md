...
The date is notable because it falls in the same week as the launch of **Thefacebook** at Harvard on **4 February 2004**. This should be phrased precisely: Canal Barra was legally formalized in the same week that Thefacebook launched as a Harvard social-networking website, not in the same week that Facebook itself was incorporated as a company.

The comparison is useful as a chronological symmetry, not as a claim of equivalence. Thefacebook represented the emerging centralized profile-graph lineage of Web 2.0 social platforms. Canal Barra represented a different Brazilian path: the institutionalization of a hybrid system that had already operated since 1996 through IRC presence, web persistence, offline anchoring, public reputation and local governance.
...
> In February 2004, in the same week that Thefacebook launched at Harvard, Canal Barra was formalized in Brazil as Organização Canal Barra Consultoria de Sistemas LTDA. The significance is not equivalence between the two projects, but historical symmetry: while the U.S. platform lineage was moving toward centralized profile graphs, Canal Barra was institutionalizing an already mature Brazilian IRC-Web-Presence ecosystem.

Avoid:

> Canal Barra was the Brazilian Facebook.

Avoid:

> Canal Barra and Facebook were founded as companies in the same week.

Avoid:

> This proves that Canal Barra had the same global impact as Facebook.
